...
Command: npx gltfjsx@6.2.10 social.gltf --transform 
...
export default function Model(props) {
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.polySurface13_lambert19_0.geometry} material={materials.lambert19} position={[0.158, 4.908, 3.57]} rotation={[0, Math.PI / 2, 0]} scale={0.241} />
      ...
      <mesh geometry={nodes.polySurface6_lambert16_0.geometry} material={materials.PaletteMaterial002} position={[0.168, 4.908, 2.974]} rotation={[0, Math.PI / 2, 0]} scale={0.241} />
      <mesh geometry={nodes.polySurface7_lambert18_0.geometry} material={materials.lambert18} position={[0.168, 4.908, 2.974]} rotation={[0, Math.PI / 2, 0]} scale={0.241} />
      <mesh geometry={nodes.bevelPolygon8_lambert24_0.geometry} material={materials.PaletteMaterial003} position={[0.2, 5.827, 1.894]} rotation={[0, Math.PI / 2, 0]} scale={0.264} />
    </group>
  )
}
